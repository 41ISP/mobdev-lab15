...
_Верстку можно просить генерировать нейронку, но только HTML, за React код буду снимать баллы_
...
API использует JSON файл (`database.json`) для хранения данных со следующей структурой:
...
При первом запуске файл создается автоматически с пустыми массивами.
